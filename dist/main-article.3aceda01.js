...
})({"1bMy3":[function(require,module,exports) {
var HMR_HOST = null;var HMR_PORT = 1234;var HMR_ENV_HASH = "d751713988987e9331980363e24189ce";module.bundle.HMR_BUNDLE_ID = "b00fe86630eac44fd32f1aae3aceda01";/* global HMR_HOST, HMR_PORT, HMR_ENV_HASH */
...
},{}],"14OMs":[function(require,module,exports) {
...
const bindFocusEvents = () => {
  ...
  function toggleSearchFocus() {
    var isFocused = document.activeElement === navSearchField || document.activeElement === mobileSearchField;
...
const bindVoteEvents = () => {
  ...
  voteButtonCollection.forEach((value, key, parent) => {
  ...
  function switchVoteType() {
    ...
    voteTypeLabel.forEach((value, key, parent) => {
  ...
  function updateScores(newVoteType) {
    ...
    if (newVoteType === "Community") {
      scores.forEach((value, key, parent) => {
        value.innerHTML = blogTile[key].community_score;
      });
      totalVotes.forEach((value, key, parent) => {
        // format numerical display eg. 1000 -> 1K
        value.innerHTML = _helper.kFormatter(blogTile[key].community_total_vote_count);
      ...
      totalVotes.forEach((value, key, parent) => {
        // format numerical display eg. 1000 -> 1K
        value.innerHTML = _helper.kFormatter(blogTile[key].expert_total_vote_count);
      });
    }
  }
...
},{}]},{},["1bMy3","14OMs"], "14OMs", "parcelRequire6a70")

//# sourceMappingURL=main-article.3aceda01.js.map
