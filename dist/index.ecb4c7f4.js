...
})({"3Akdd":[function(require,module,exports) {
var HMR_HOST = null;var HMR_PORT = 1234;var HMR_ENV_HASH = "d751713988987e9331980363e24189ce";module.bundle.HMR_BUNDLE_ID = "a6c47ba7b1ab67b640a63402ecb4c7f4";/* global HMR_HOST, HMR_PORT, HMR_ENV_HASH */
...
},{}],"3lfGx":[function(require,module,exports) {
...
$(document).ready(function () {
  ...
  voteTypeDisplay.forEach((value, key, parent) => {
  ...
  function updateScores(newVoteType) {
    ...
    if (newVoteType === "Community") {
      ...
      totalVotes.forEach((value, key, parent) => {
        ...
        value.innerHTML = _helper.kFormatter(blogTiles[key].community_total_vote_count);
      ...
      totalVotes.forEach((value, key, parent) => {
        // format numerical display eg. 1000 -> 1K
        value.innerHTML = _helper.kFormatter(blogTiles[key].expert_total_vote_count);
      });
    }
  }
});
},{"./helper":"fIfDq"}]},{},["3Akdd","3lfGx"], "3lfGx", "parcelRequire6a70")

//# sourceMappingURL=index.ecb4c7f4.js.map
